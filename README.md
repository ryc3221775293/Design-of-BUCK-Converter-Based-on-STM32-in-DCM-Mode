...
![MINI-STM32_页面_1](.\PCB\Image\MINI-STM32_页面_1.jpg)



#### PCB如图

![MINI-STM32_页面_2](.\PCB\Image\MINI-STM32_页面_2.jpg)

#### PCB板的3D效果如图

![STM32](.\PCB\Image\STM32.png)

#### BOM报表如下

![MINI-STM32_页面_3](.\PCB\Image\MINI-STM32_页面_3.jpg)
...
![TIM截图20181202202550](.\PCB\Image\TIM截图20181202202550.png)
...
![TIM截图20181202203009](.\PCB\Image\TIM截图20181202203009.png)
...
![2018-12-02_203312](.\PCB\Image\2018-12-02_203312.gif)
...
![TIM截图20181202203608](.\PCB\Image\TIM截图20181202203608.png)

#### SPI FLASH 

STM32开发板载有SPIFLASH芯片W25Q64，该芯片的容量为8M字节，其原理图如下：

![TIM截图20181202203720](.\PCB\Image\TIM截图20181202203720.png)
...
![TIM截图20181202203911](.\PCB\Image\TIM截图20181202203911.png)
...
![Drive_Circuit_页面_1](.\PCB\Image\Drive_Circuit_页面_1.jpg)

#### PCB如下

![Drive_Circuit_页面_2](.\PCB\Image\Drive_Circuit_页面_2.jpg)

#### 3D效果图如下

![Drive](.\PCB\Image\Drive.png)

#### BOM报表如下

![Drive_Circuit_页面_3](.\PCB\Image\Drive_Circuit_页面_3.jpg)

### 3、主电路

#### 主电路原理图如下

![BUCK_页面_1](.\PCB\Image\BUCK_页面_1.jpg)

#### PCB如下

![BUCK_页面_2](.\PCB\Image\BUCK_页面_2.jpg)

#### 3D效果图如下

![BUCK](.\PCB\Image\BUCK.png)

#### BOM报表如下

![BUCK_页面_3](.\PCB\Image\BUCK_页面_3.jpg)
...
![TJC3224T028_011X_页面_2](.\PCB\Image\TJC3224T028_011X_页面_2.jpg)
...
![TIM截图20181202205637](.\PCB\Image\TIM截图20181202205637.png)
...
![TIM截图20181202210433](.\PCB\Image\TIM截图20181202210433.png)
...
![TIM截图20181202210706](.\PCB\Image\TIM截图20181202210706.png)
...
![TIM截图20181202211151](.\PCB\Image\TIM截图20181202211151.png)
...
![TIM截图20181202212052](.\PCB\Image\TIM截图20181202212052.png)
...
![TIM截图20181202212159](.\PCB\Image\TIM截图20181202212159.png)

图中任务A的变量x值为10，将这个值发送到消息队列中。此时队列剩余长度就是3了。前面说了向队列中发送消息是采用拷贝的方式，所以一旦消息发送完成变量x就可以再次被使用，赋其他的值。

+ 向队列发送第二个消息

![TIM截图20181202212249](.\PCB\Image\TIM截图20181202212249.png)

图中任务A又向队列发送了一个消息，即新的x的值，这里是20。此时队列剩余长度为2。

+ 从队列中读取消息

![TIM截图20181202212402](.\PCB\Image\TIM截图20181202212402.png)
